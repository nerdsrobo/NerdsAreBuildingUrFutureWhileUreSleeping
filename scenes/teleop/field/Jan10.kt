...
public class Jan10() : TeleOpBuilder() {
    override fun init_(P: RobotPack) {
        ...
        GAPI.bindArray({true}, {true}, { arrayOf(gamepad1.left_stick_x.toDouble(), -gamepad1.left_stick_y.toDouble(), gamepad1.right_stick_x.toDouble())}, {pw: Array<Double> -> {wb.setAxisPower(pw[0], pw[1], pw[2])}});
        ...
        GAPI.bindDouble({true}, {true}, {gamepad1.right_trigger.toDouble() - gamepad1.left_trigger.toDouble()}, {pw: Double -> {srt.setPwSort(pw)}})
