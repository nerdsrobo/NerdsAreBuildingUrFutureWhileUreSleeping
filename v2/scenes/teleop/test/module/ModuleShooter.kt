...
class ModuleShooter(): TeleOpPacker() {
    override fun init_(P: RobotPack) {
        ...
        linkerApi.bindDouble({true}, {!gamepad1.y && !gamepad1.a}, {gamepad1.left_stick_y.toDouble()}, {pw -> sht.SHT_L.power = pw});
        linkerApi.bindDouble({true}, {!gamepad1.y && !gamepad1.a}, {gamepad1.right_stick_y.toDouble()}, {pw -> sht.SHT_R.power = pw});
